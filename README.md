# nvim-treesitter-queries-hlsplaylist

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-hlsplaylist/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-hlsplaylist/actions/workflows/validate.yml)

Neovim tree-sitter queries for **hlsplaylist**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-hlsplaylist",
...
- [ ] Changes are scoped to `hlsplaylist` — do not include files for other languages
